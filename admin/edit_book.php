...
if (isset($_POST['update'])) {
    ...
    if ($dup->get_result()->num_rows > 0) {
        ...
        $update->bind_param("sissssidiiissssi", $dateOfAccession, $accessionNo, $subject, $author, $title, $publisher, $year, $price, $total, $quantity, $billNo, $billDate, $supplier, $edition, $remarks, $id);
        $update->execute();
        header("Location: manage_books.php");
        exit();
    }
