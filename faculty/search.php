...
<div class="overlay">
    <div class="header">
        <div style="display:flex; align-items:center; gap:10px;"><img src="../assets/trisha-logo.svg" alt="Trisha Logo" style="width:44px;height:44px;border-radius:10px;background:white;object-fit:contain;"><h2>📘 Trisha Faculty Library Search</h2></div>
