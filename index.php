...
<style>
:root{--primary:#E24C24;--primary2:#C93E18;--muted:#64748b}
...
input,select{width:100%;padding:14px;border-radius:12px;border:1px solid #d9dfeb;background:#edf1fb;font-size:15px}
